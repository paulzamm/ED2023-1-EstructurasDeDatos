...
/**
 * Árbol AVL parametrizado para objetos comparables genéricos tipo T
 * @author Fausto Redrován 
 * @param <T> clase del objeto elemento del árbol
 */
public class ArbolAVL<T extends Comparable<T>> extends ArbolBB<T> {
	private static final long serialVersionUID = 1L;

	/**
	 * Constructor de un árbol AVL de nombre <em>nombre</em> y con un nodo raíz con el <em>dato</em>
	 * @param nombre Nombre del árbol AVL
	 * @param dato Para el nodo raíz
	 */
	...
	/**
	 * Constructor de un árbol AVL con nombre y vacío (nulo)
	 * @param nombre Nombre del árbol nulo (vacío)
	 */
	...
	/**
	 * Constructor de un árbol AVL sin nombre y con un nodo raíz con el <em>dato</em>
	...
	/**
	 * Constructor de un árbol AVL sin nombre y vacío
	 */
	public ArbolAVL() {
		super();
	}
	...
	/**
	 * Busca un objeto <em>dato</em> a partir de la raíz
	...
	/**
	 * Busca un objeto <em>dato</em> a partir del subárbol <em>arbol</em>
	 * @param arbol Subárbol
	 * @param dato Objeto a buscar
	 * @return Nodo que contiene el objeto si lo encuentra, y <em>null</em> si no lo encuentra
	 */
	...
	/**
	 * Inserta un nuevo nodo en el árbol AVL a partir de un subárbol. 
	 * Si el objeto del nuevo nodo ya existe en el árbol, este no se inserta.
	 * Si el nuevo nodo produce un desbalanceo, se producen las rotaciones necesarias para balancear el árbol.
	 * Esto generará una variación en el subárbol que se rota y por tanto el método entrega una nueva raíz de dicho subárbol.
	 * @param nuevo Nodo a insertar con un objeto nuevo
	 * @param arbol Raíz del subárbol a partir del que se insertará el nodo
	 * @return La raíz del subárbol (rotado o no) donde se ingresó el nodo
	 */
	...
	/**
	 * Inserta un nuevo objeto en el árbol. Si el objeto ya existe no se inserta.
